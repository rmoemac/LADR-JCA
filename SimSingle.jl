...
int_method = 3 #1 is mdpt, 2 is yoshida, 3 is rk4
...
function midpt_orbital_encounter(t,y)
...
@time begin
    results_yoshi = midpoint(t_span,initial_conditions,dt)
end
...
if int_method == 3
    @time begin
        results_yoshi = rk4(t_span,initial_conditions,dt)
    end
    return laser_positions, debris_positions
end
